...
- 🏠 **Homepage** - Halaman utama dengan slider gambar dan informasi perusahaan
- 🚌 **Armada** - Informasi mengenai armada kendaraan yang tersedia
- 📖 **About Us** - Profil perusahaan dan informasi kantor cabang
- ❓ **FAQ** - Pertanyaan yang sering diajukan
- 📝 **Quisioner** - Form kuesioner untuk feedback pelanggan
- 🔐 **Login** - Sistem autentikasi pengguna
- 🎫 **Cek Tiket** - Fitur untuk mengecek status tiket perjalanan
...
├── 📄 armada.php         # Halaman armada kendaraan
├── 📄 FAQ.php            # Halaman FAQ
├── 📄 Quisioner.php      # Halaman kuesioner
├── 📄 login.php          # Halaman login
├── 🎨 new.css            # Stylesheet untuk homepage
├── 🎨 about.css          # Stylesheet untuk halaman about
├── 🎨 armada.css         # Stylesheet untuk halaman armada
├── 🎨 FAQ.css            # Stylesheet untuk halaman FAQ
├── 🎨 Quisioner.css      # Stylesheet untuk halaman kuesioner
├── 🎨 login.css          # Stylesheet untuk halaman login
├── 📜 login.js           # JavaScript untuk halaman login
├── 📁 assets/            # Gambar dan font
│   ├── 🖼️ Travel.png     # Logo utama
│   ├── 🖼️ logo.jpg       # Banner slider 1
│   ├── 🖼️ logo2.jpg      # Banner slider 2
│   ├── 🖼️ Bali.jpg       # Gambar kantor Bali
│   ├── 🖼️ Surabaya.jpg   # Gambar kantor Surabaya
│   ├── 🖼️ malang.jpg     # Gambar kantor Malang
│   ├── 🖼️ Jogja.jpg      # Gambar kantor Yogyakarta
│   ├── 🖼️ minibus.png    # Icon minibus
│   └── 🔤 Poppins-*.ttf  # Font Poppins family
...
© 2025 GoGoTrans. All Rights Reserved.

---

<div align="center">

**Made with ❤️ by GoGoTrans Team**

🌴 Bali | 🏙️ Surabaya | 🏔️ Malang | 🕌 Yogyakarta
